...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(70, 400)), 100, 10);
...
function greenBalloon() {
  ...
  var green = createSprite(0,Math.round(random(100, 190)), 200, 10);
...
function pinkBalloon() {
  ...
  var pink = createSprite(0,Math.round(random(150, 270)), 10, 10);
